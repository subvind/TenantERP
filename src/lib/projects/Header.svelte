...
<div class="fair-source z-depth-5">
  <div class="container">
    <h1 class="title">
      Fair Source 25 (v0.9).
    </h1>
    <div class="description" style="color: #000;">Source code to an Innovation Management System (IMS)...</div>
    <br />
