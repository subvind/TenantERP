...
<div class="card">
  ...
  <div class="card-content">
    <p>
      Hello There!
      <br />My name is Travis. I am a full stack developer. This place is my personal portfolio and ground base for launching <a href="/solutions">Solutions</a> to <a href="/production">Production</a> that will install in just 1-click or chat with <a href="/my-assistant">My Assistant</a> who is an AI bot.
      <br /><br />My goal is to establish a single monolithic database or <a href="/platforms">Platform</a> that all my <a href="/projects">Projects</a> use and connect to. Like Supabase and a CMS except for applications. Which entails quite a bit of things so look further into <a href="/about">About</a> for more information on that.
      ...
      <br /><br />If you like the work I'm doing around here consider becoming an isTrav <a href="/partner">Partner</a> today. If your looking for talent print out my <a href="/resume">Resume</a>, send my <a href="https://github.com/trabur">GitHub</a> to the coding team, and <a href="#" on:click={() => contactMe()}>Contact Me</a> for hire.
